...
$fs->addOpt('interval', 'i', 'Specify at which interval to send each message.', FlagType::FLOAT, false, 0.001);
...
$fs->addOpt('port', 'p', 'Specify the port to connect to.', FlagType::INT, false, 8080);
